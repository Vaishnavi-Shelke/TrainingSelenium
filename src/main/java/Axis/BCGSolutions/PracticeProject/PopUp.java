...
public class PopUp{ 
	 ...
	 public static void main(String[] args) throws InterruptedException { 
	  ...
	  click1.click(); 
	  System.out.println("Clicked on click 1 successfully"); 
	  ...
	  click2.click(); 
	  Thread.sleep(900); 
	  System.out.println("Clicked on click 2 successfully"); 
	  ...
	  click4.click(); 
	  Thread.sleep(900); 
	  System.out.println("Clicked on click 4 successfully"); 
	  alt.accept(); 
	  Thread.sleep(800); 
	  System.out.println("Clicked on popup alert successfully"); 
	  click4.click(); 
	  Thread.sleep(900); 
	  alt.dismiss(); 
